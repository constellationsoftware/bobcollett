<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="manageowner.aspx.cs" Inherits="admin_manageowner" %>
                ...
                <div class="view5">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right">
                                <a href="Owner.aspx" title="Add Owner">Add Owner</a>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPortfolio" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                    ...
                                    <Columns>
                                        <asp:BoundField AccessibleHeaderText="Name" HeaderText="Owner Name" DataField="Owner" SortExpression="Name" />                                       
                                        <asp:TemplateField AccessibleHeaderText="Options" HeaderText="Options" ItemStyle-VerticalAlign="Middle"
                                            ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:ImageButton ImageUrl="images/drop.png" ID="Button1" runat="server" CausesValidation="False" CommandName="Delete" CommandArgument='<%# Eval("id") %>' OnClick="Button1_Click" OnClientClick="showConfirm(this); return false;" Text="Delete" />
                                                <a href="owner.aspx?oid=<%# Eval("id") %>"><img alt="Edit" src="images/Update.png" title="Edit" border="0" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
