<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="managemgr.aspx.cs" Inherits="admin_managemgr" %>
                ...
                <div class="view5">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right">
                                <a href="mgr.aspx" title="Add Mgr">Add Mgr</a>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvPortfolio" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                    ...
                                    <Columns>
                                        <asp:BoundField AccessibleHeaderText="Name" HeaderText="Mgr Name" DataField="mgr" SortExpression="Name" />                                       
                                        <asp:TemplateField AccessibleHeaderText="Options" HeaderText="Options" ItemStyle-VerticalAlign="Middle"
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <a href="mgr.aspx?mid=<%# Eval("id") %>"><img alt="Edit" src="images/Update.png" title="Edit" border="0" /></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
