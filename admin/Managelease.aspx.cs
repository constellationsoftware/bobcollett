...
public partial class admin_Managelease : System.Web.UI.Page
{
    ...
    {
        this.gvPortfolio.DataSource = objlease.GetLease();  
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int lid = int.Parse(btnDelete.CommandArgument);
            if (objlease.DeleteLeaseById(lid))
            {
                message = "Lease has been deleted successfully.";
            }
            else
            {
