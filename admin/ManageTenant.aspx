<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true"
    CodeFile="ManageTenant.aspx.cs" Inherits="admin_ManageTenant" %>
                ...
                <div class="view5">
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right">
                                <a href="Tenant.aspx" title="Add Tenant">Add Tenant</a>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="gvUsers" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Both"
                                    ...
                                    <Columns>
                                        <asp:TemplateField AccessibleHeaderText="Tenant Name" HeaderText="Tenant Name" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltenantname" runat="server" Text='<%# Eval("First_name") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField AccessibleHeaderText="Options" HeaderText="Options" ItemStyle-VerticalAlign="Middle"
                                            ...
                                            <ItemTemplate>
                                                <asp:ImageButton ImageUrl="images/drop.png" ID="Button1" runat="server" CausesValidation="False" CommandName="Delete"
                                                    CommandArgument='<%# Eval("Tenant_id") %>' OnClick="Button1_Click" OnClientClick="showConfirm(this); return false;"
                                                    Text="Delete" />
                                                <a href="Tenant.aspx?tid=<%# Eval("Tenant_id") %>">
